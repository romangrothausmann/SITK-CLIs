...
print("Min\tMax\tMean\tStd\tVariance\tSum\tName\tSize")
...
#    print(d)
    for i in range(d.GetNumberOfComponentsPerPixel()):
        print(i)
        ...
        print("%f\t%f\t%f\t%f\t%f\t%f\t%s\t" # http://stackoverflow.com/questions/3264828/change-default-float-print-format
              % (
                  stat.GetMinimum(),
                  stat.GetMaximum(),
                  stat.GetMean(),
